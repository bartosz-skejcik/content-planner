...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-wrap gap-1 p-2 ring-1 text-sm ring-transparent rounded-md bg-muted",
        {
    ...
    >
      {value.map((item, index) => (
        <Badge
          key={item}
          className={cn(
            "px-1 pl-2 -my-1 rounded-md flex items-center gap-1 capitalize",
...
>(({ className, value, children, ...props }, ref) => {
  ...
  return (
    <CommandItem
      ...
      className={cn(
        "rounded-md cursor-pointer px-2 py-1 my-0.5 transition-colors flex justify-between text-md font-light",
        className,
